...
module.exports = class MonsterGame {
  ...
  // List monsters
  listMonsters = () => {
      monsterList.forEach(iterater);
  }
  //Function that lists monsters
  listMonsters = () => {
    monsterList.forEach((item) => console.log(`Monster: ${item.monsterName}, Minimum Life: ${item.minimumLife}, Current Life: ${item.currentLife}, Status: ${""}`));
}
